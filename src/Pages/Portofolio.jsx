...
export default function FullWidthTabs() {
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#050303] overflow-hidden" id="Portofolio">
      {/* Header section - unchanged */}
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#2563eb] to-[#dc2626]">
          <span style={{
            color: '#2563eb',
            backgroundImage: 'linear-gradient(45deg, #2563eb 10%, #dc2626 93%)',
