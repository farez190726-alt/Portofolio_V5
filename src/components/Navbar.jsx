                ...
                <div className="flex items-center justify-between h-16">
                                    ...
                                    <span
                                        className={`relative z-10 transition-colors duration-300 ${
                                            activeSection === item.href.substring(1)
                                                ...
                                                : "text-[#e9e2e2] group-hover:text-white"
                                        }`}
                                    >
                                        {item.label}
                                    </span>
                                    <span
                                        className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#2563eb] to-[#dc2626] transform origin-left transition-transform duration-300 ${
                                            activeSection === item.href.substring(1)
                                                ? "scale-x-100"
                    ...
                    <div className="md:hidden">
                        <button
                            ...
                            className={`relative p-2 text-[#e9e2e2] hover:text-white transition-transform duration-300 ease-in-out transform ${
