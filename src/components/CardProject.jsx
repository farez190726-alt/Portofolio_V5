  ...
  return (
    <div className="group relative w-full">
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-lg border border-white/10 shadow-2xl transition-all duration-300 hover:shadow-rose-600/20">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-rose-600/10 to-red-600/10 opacity-50 group-hover:opacity-70 transition-opacity duration-300"></div>
        ...
        <div className="relative p-5 z-10">
          ...
          <div className="mt-4 space-y-3">
            <h3 className="text-xl font-semibold bg-gradient-to-r from-blue-200 via-rose-200 to-red-200 bg-clip-text text-transparent">
              {Title}
            </h3>
          ...
          <div className="absolute inset-0 border border-white/0 group-hover:border-rose-600/50 rounded-xl transition-colors duration-300 -z-50"></div>
        </div>
      </div>
    </div>
  );
